...
public class mainclass extends JPanel implements Runnable{
    ...
    public static Sound musica = new Sound("/sonidos/music.wav");
    ...
    Font font = new Font("Ubuntu", Font.TRUETYPE_FONT, 35);
    ...
    MaterialButton btnStart = new MaterialButton();
    MaterialButton btnRestart = new MaterialButton();
    MaterialButton btnExit = new MaterialButton();
    MaterialButton btnAbout = new MaterialButton();
    ...
    private void initComponets(){
        this.setLayout(null);
        this.setBackground(MaterialColor.GREY_900);
        
        btnStart.setBounds(1, ancho-63, 130, 30);
        btnStart.setText("Play/Pause");
        btnStart.setForeground(Color.WHITE);
        btnStart.setBackground(MaterialColor.GREEN_400);
        ...
        btnRestart.setBackground(MaterialColor.AMBERA_200);
        ...
        btnAbout.setBounds(largo-170, ancho-63, 100, 30);
        btnAbout.setText("About");
        btnAbout.setForeground(Color.WHITE);
        btnAbout.setBackground(MaterialColor.TEAL_200);
        btnAbout.setFocusable(false);
        btnAbout.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent ae) {
                btnAboutActionPerformed(ae);
            }
        });
        add(btnAbout);
        ...
        btnExit.setBackground(MaterialColor.RED_300);
        ...
        Slider.setBackground(MaterialColor.GREY_900);
    ...
    public void paint(Graphics g) {
        ...
        g2d.setColor(MaterialColor.BLUEA_100);
        g2d.setFont(font);
